                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <div>
                                ...
                                <ul>
                                <li class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed"><a href="./learners/{{ $learner->id }}">{{ ucfirst($learner->first_name) . ' ' . ucfirst($learner->last_name) }}</a></li>                                </ul>
                                @endforeach

                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Comments</h2>

                                @foreach($sentences as $sentence)
                                <ul>
                                <li class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed"><a href="./sentences/{{ $sentence->id }}">{{ ucfirst($sentence->body) }}</a></li>                                </ul>
                                @endforeach

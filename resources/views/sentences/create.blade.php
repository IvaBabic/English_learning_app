                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Create a sentence</h2>

                                <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ route('create')}}">
       @csrf
